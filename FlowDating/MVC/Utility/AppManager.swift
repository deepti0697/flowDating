...
//    func getLatLong() -> userLatLong {
//
//        let location = userLatLong()
//        location.latitute = UserDefaults.standard.object(forKey: "latitude") as? Double
//        location.longitute = UserDefaults.standard.object(forKey: "longitute") as? Double
//        location.userAddress = UserDefaults.standard.object(forKey: "userAddress") as? String
//        return location
//    }
    func hudShow()  {
    ...
    func showToast(_ msg: String?) {
        ...
        appDelegate?.window?.makeToast(msg, duration: 1.0, position: .bottom)
    }
